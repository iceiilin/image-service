...
function NorthboundApiFactory(
    ...
    function uploadFile(req, res, filePath) {
        ...
        return uploader.upload(req, res)
            ...
            // It is usually found in the unittest that microkernel file
            // has been uploaded but getFileSizeSync is still 0.
            // TODO: investigate to change the file process to async methods
            //.then(function(){
